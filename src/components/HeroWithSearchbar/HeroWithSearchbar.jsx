...
export const HeroWithSearchbar = () => {
    return (
        <>
            <section
                className="bg-[url('https://flowbite.s3.amazonaws.com/blocks/marketing-ui/hero/coast-house-view.jpg')] bg-no-repeat bg-cover bg-center bg-gray-700 bg-blend-multiply">
                <div className="relative py-8 px-4 mx-auto max-w-screen-xl text-white lg:py-32 xl:px-0 z-1">
                    <div className="mb-6 max-w-screen-md lg:mb-0">
                        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-tight text-white md:text-5xl lg:text-6xl">Welcome Home, We’re here for you</h1>
                        <p className="mb-6 font-light text-gray-300 lg:mb-8 md:text-lg lg:text-xl">Matching you with the perfect recovery residences that fit your needs</p>
                        {/*<a href="#"*/}
