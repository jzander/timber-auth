export const AppDownloadHomeowners = () => {
    return (
        <section className="bg-white dark:bg-gray-900 antialiased">
            <div className="px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24 max-w-5xl">
                <div className="text-center">
                    <div>
                        <h2
                            className="text-3xl font-extrabold leading-none tracking-tight text-gray-900 dark:text-white sm:text-5xl lg:text-6xl">
                            Login to our homeowner portal on our mobile app
                        </h2>
                        <p
                            className="mt-4 text-base font-normal text-gray-500 dark:text-gray-400 md:max-w-3xl md:mx-auto sm:text-xl">
                            Use 1 Emergency Tree Service for all emergency tree service
                            solutions and alleviate the stress of an unexpected situation.
                        </p>
                    </div>
                    ...
                    <div className="flex items-center justify-center gap-4 mt-8 max-w-sm mx-auto">
                        <a href="#" title=""
                           ...
                           role="button">
                            <svg aria-hidden="true" className="h-8 w-8 sm:w-10 sm:h-10" xmlns="http://www.w3.org/2000/svg"
                                 viewBox="0 0 24 24"
                                 fill="currentColor">
                                <path
                ...
                <div className="my-8 sm:my-16">
                    <div
                        className="relative mx-auto border-gray-800 dark:border-gray-800 dark:bg-gray-800 border-[14px] rounded-[2.5rem] h-[600px] w-[300px]">
                        <div
                ...
                <div className="flex items-center justify-center gap-5 sm:gap-6 sm:mt-8">
                    <div className="flex -space-x-3 overflow-hidden">
                        <img className="inline-block w-8 h-8 border border-white rounded-full dark:border-gray-900"
                    ...
                    <div>
                        <div className="flex items-center gap-1.5">
                            <div className="flex items-center gap-0.5">
                                <svg aria-hidden="true" className="w-5 h-5 text-yellow-300"
                        ...
                        <p className="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                            Rated Best Over <span
                            className="font-semibold text-gray-900 dark:text-white">15.7k</span> Reviews
                        </p>
                    </div>
                </div>
            </div>
