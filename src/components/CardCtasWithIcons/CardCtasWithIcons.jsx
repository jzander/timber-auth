export const CardCtasWithIcons = () => {
    return (
        <section className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 ">
                <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Homeowners
                    face obstacles too.</h2>
                <p className="mb-3 font-light text-gray-500 dark:text-gray-400 sm:text-xl">Many lack the industry
                    knowledge to choose the right contractor or to ensure
                    services fall within their policy limits. These three sectors need to
                    work together seamlessly, yet they often don’t due to a few critical missing elements.</p>
                <p className="mb-8 font-light text-gray-500 dark:text-gray-400 sm:text-xl">
                    1 Tree Emergency aims to bridge these gaps, becoming the essential link for arborists, adjusters,
                    and homeowners across the U.S.
                </p>
                <div className="grid gap-8 lg:grid-cols-2">
                    <a href="#"
                       className="inline-flex justify-center items-center p-5 text-base font-medium text-gray-500 bg-gray-50 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
                        <svg className="mr-3 w-5 h-5" viewBox="0 0 32 32" fill="none"
                        ...
                        <span className="w-full">A Member Network of licensed and certified companies</span>
                    ...
                    <a href="#"
                       className="inline-flex justify-center items-center p-5 text-base font-medium text-gray-500 bg-gray-50 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
                        <svg className="mr-3 w-5 h-5" viewBox="0 0 22 31" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="w-full">Accredited by prestigious industry associations</span>
                        <svg className="ml-3 w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                             xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd"
                                  d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z"
                    ...
                    <a href="#"
                       className="inline-flex justify-center items-center p-5 text-base font-medium text-gray-500 bg-gray-50 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
                        <svg className="mr-3 w-5 h-5" viewBox="0 0 26 31" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="w-full">Handling insurance jobs with precision and ease</span>
                        <svg className="ml-3 w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                             xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd"
                                  d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z"
                    ...
                    <a href="#"
                       className="inline-flex justify-center items-center p-5 text-base font-medium text-gray-500 bg-gray-50 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
                        <svg className="mr-3 w-5 h-5" viewBox="0 0 33 21" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                            <path
                            ...
                            <defs>
                                <linearGradient id="paint0_linear_4151_63014" x1="-0.91663" y1="6.56015" x2="27.5845"
                                                y2="22.9931" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#2298BD"/>
                                    <stop offset="1" stop-color="#0ED7B5"/>
                                </linearGradient>
                            </defs>
                        </svg>
                        <span className="w-full">Adhering to policy limits of our insurance partners</span>
                        <svg className="ml-3 w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                             xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd"
                                  d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z"
