...
export const NewsletterSignup = () => {
    ...
    return (
        <section className="bg-gray-50 dark:bg-gray-800 max-w-full">
                    ...
                    >
                        ...
                        <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                            <div className="relative w-full">
                                ...
                                <input
                                    className="block p-3 pl-9 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-0 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        <div className="mx-auto mb-3 space-y-4 max-w-screen-sm">
                            {message && (
                                <div
                                    className="sm:flex w-fit sm:space-y-0 bg-green-100 text-green-800 text-sm font-medium px-5 py-2 rounded dark:bg-gray-700 dark:text-green-400 border border-green-400">
                                    {message}
                                </div>
                            )}
                        </div>
